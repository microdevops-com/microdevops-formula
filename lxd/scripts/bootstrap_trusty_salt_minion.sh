...
echo "deb http://repo.saltstack.com/apt/ubuntu/$(lsb_release -sr)/amd64/2018.3 $(lsb_release -sc) main">> /etc/apt/sources.list.d/saltstack.list
/usr/bin/wget -qO - https://repo.saltstack.com/apt/ubuntu/$(lsb_release -sr)/amd64/2018.3/SALTSTACK-GPG-KEY.pub | apt-key add -
