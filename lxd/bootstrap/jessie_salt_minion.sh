...
echo "deb http://repo.saltstack.com/apt/debian/8/amd64/$2 jessie main">> /etc/apt/sources.list.d/saltstack.list
/usr/bin/wget -qO - https://repo.saltstack.com/apt/debian/8/amd64/$2/SALTSTACK-GPG-KEY.pub | apt-key add -
