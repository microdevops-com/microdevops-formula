...
if [[ "$color_prompt" = yes ]]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\D{%Y-%m-%d} \t bg:\j $(git_color_prompt)\u@\H\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\n\$ '
else
    PS1='${debian_chroot:+($debian_chroot)}\D{%Y-%m-%d} \t bg:\j $(git_prompt)\u@\H:\w\n\$ '
fi
