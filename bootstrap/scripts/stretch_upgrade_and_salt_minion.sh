...
echo "deb http://repo.saltstack.com/apt/debian/9/amd64/${SALT_VERSION} stretch  main">> /etc/apt/sources.list.d/saltstack.list
/usr/bin/wget -qO - https://repo.saltstack.com/apt/debian/9/amd64/${SALT_VERSION}/SALTSTACK-GPG-KEY.pub | apt-key add -
