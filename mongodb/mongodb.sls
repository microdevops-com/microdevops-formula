{% if pillar['mongodb'] is defined and pillar['mongodb'] is not none and pillar['mongodb']['enabled'] is defined and pillar['mongodb']['enabled'] is not none and pillar['mongodb']['enabled'] and pillar['mongodb']['version'] is defined and pillar['mongodb']['version'] is not none %}
install_1:
  pkg.installed:
    - refresh: True
    - reload_modules: True
