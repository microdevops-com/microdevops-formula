{% if pillar['notify_devilry'] is defined and pillar['notify_devilry'] is not none and pillar['notify_devilry']['enabled'] is defined and pillar['notify_devilry']['enabled'] is not none and pillar['notify_devilry']['enabled'] %}
