...
stdbuf -oL -eL echo "---"
stdbuf -oL -eL echo "NOTICE: CMD: cd /srv && git checkout -B master origin/master && git pull --prune"
( cd /srv && stdbuf -oL -eL git checkout -B master origin/master && stdbuf -oL -eL git pull --prune ) || GRAND_EXIT=1
stdbuf -oL -eL echo "---"
